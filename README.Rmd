...
cat(
  ...
  # badge_cran_release("wig", "green"),
  # badge_cran_download("wig", "grand-total", "green"),
  # badge_cran_checks("wig"),
  badge_github_actions("fangzhou-xie/wig", "R-CMD-check.yaml"),
  badge_license()
)
```
<!-- badges: end -->
...
[documentation website](https://fangzhou-xie.github.io/wig/).
