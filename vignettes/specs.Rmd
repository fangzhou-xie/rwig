...
and it is passed to `cut()` as the `breaks` argument (see `?cut.Date`).
The default option is "month" to obtain a monthly time series index;
other options include "day", "week" (starting on Monday), "quarter", "year",
or multiples such as "2 months".
