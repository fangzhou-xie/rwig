...
// TODO: extend the vector class? or adding some functions?

///////////////////////////////////////////////////////////////////
// Functions extending the `doubles` class
///////////////////////////////////////////////////////////////////
// functions seems easier? Let's do that now



// following R's naming convention
int nrow(const doubles& a) { return Rf_nrows(a); }
int ncol(const doubles& a) { return Rf_ncols(a); }

// for leveraging the Symmetric BLAS routine
  ...
  writable::r_vector<double>
{
  ...
  out.attr(R_DimSymbol) = Rf_getAttrib(a.data(), R_DimSymbol);
  return(out);
}
...
auto aKv(const doubles& a, const doubles& K, const doubles& v) ->
  ...
  r.attr(R_DimSymbol) = r_vector<int>({M_, N_});
  return(r);
}
...
auto operator*(const doubles& lhs, const doubles& rhs) -> writable::doubles
{
  ...
  writable::r_vector<double> r(result_);
